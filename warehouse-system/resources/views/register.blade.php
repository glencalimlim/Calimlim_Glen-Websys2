...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-wrap { display: flex; width: 100%; max-width: 900px; min-height: 560px; border-radius: 16px; overflow: hidden; box-shadow: 0 8px 40px rgba(0,0,0,0.12); margin: 24px; }
        ...
        /* Right panel */
        .auth-right { width: 420px; background: #fff; padding: 48px 44px; display: flex; flex-direction: column; justify-content: center; flex-shrink: 0; }
        .auth-title { font-size: 20px; font-weight: 600; color: #111827; margin-bottom: 4px; }
        .auth-subtitle { font-size: 13px; color: #9ca3af; margin-bottom: 24px; }
        ...
        .auth-link { text-align: center; margin-top: 16px; font-size: 13px; color: #9ca3af; }
        .auth-link a { color: #2563eb; text-decoration: none; font-weight: 500; }
        .auth-link a:hover { text-decoration: underline; }

        .flash-success { background: #ecfdf5; border: 1px solid #a7f3d0; color: #065f46; padding: 10px 13px; border-radius: 8px; font-size: 13px; margin-bottom: 16px; }
        .flash-error { background: #fef2f2; border: 1px solid #fecaca; color: #991b1b; padding: 10px 13px; border-radius: 8px; font-size: 13px; margin-bottom: 16px; }
        .flash-error ul { margin: 0; padding-left: 16px; }
        .flash-error li { margin-top: 2px; }
...
<div class="auth-wrap">
    ...
    <div class="auth-left">
        ...
        <div class="auth-tagline">
            ...
            <p>Create your account and start managing your warehouse inventory right away.</p>
        </div>
    ...
    <div class="auth-right">
        ...
        <div class="auth-subtitle">Fill in your details to get started</div>
        ...
        <form action="{{ route('register') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                       ...
                       class="form-input {{ $errors->has('name') ? 'error' : '' }}" required autofocus>
            </div>
