    ...
    <div class="page-header">
        <div class="page-header-row">
            <div>
                ...
                <div class="page-sub">Fill in the details to add an item to inventory</div>
            </div>
    ...
    <div class="form-card">
        <form action="{{ route('items.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <p style="font-size:11px;color:#60a5fa;margin-top:5px">
                    ⚡stock update, no duplicate.
                </p>
            </div>

            <div class="form-group" style="margin-bottom:24px">
                <label class="form-label">Description <span style="color:#9ca3af;font-weight:400;text-transform:none;letter-spacing:0">(optional)</span></label>
...
<div id="supplier-modal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.4);z-index:300;align-items:center;justify-content:center;padding:20px">
    <div style="background:#fff;border-radius:14px;width:100%;max-width:380px;padding:28px;position:relative;border:1px solid #e5e7eb">
        ...
        <div class="form-group" style="margin-bottom:20px">
            <label class="form-label">Supplier / Company Name <span style="color:#ef4444">*</span></label>
